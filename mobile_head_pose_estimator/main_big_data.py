...
def main():
    ...
    json_files = sorted(glob.glob("D:/jsons_big_data_first/snapshot_*_*.json"))
    if not json_files:
        print("ОШИБКА: Нет JSON в jsons/")
        return

    os.makedirs("D:/output_big_data", exist_ok=True)
